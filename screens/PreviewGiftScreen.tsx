...
interface IPreviewGiftScreenProps {
    navigation: NavigationProp<any>;
}

const PreviewGiftScreen: React.FC<IPreviewGiftScreenProps> = (props) => {
                    ...
                    <ScrollView style={styles.mainContainer}>
                        <View style={styles.imageBlockContainer}>
                            ...
                            <View style={styles.TextContentContainer}>
                                <Text style={[styles.contactInfoText, { fontFamily: giftInfo.gift_primary_font.description }]}>Hi, {giftInfo.gift_contact.first_name} {giftInfo.gift_contact.last_name}</Text>
                                <Text style={styles.description}>
                                    {giftInfo.message}
                                </Text>
                                <Text style={[styles.priceInfo, {fontFamily: giftInfo.gift_primary_font.description }]}>
                                    ${giftInfo.amount}
                                </Text>
                                {/* <Image
                                    source={require("../assets/images/clipartFlower.png")}
                                    style={styles.image}
                                    resizeMode="cover"
                                /> */}
                            </View>
...
export default PreviewGiftScreen;
