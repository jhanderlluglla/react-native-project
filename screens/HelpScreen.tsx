      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.contentInfo}>
            In order to use Giftd, you must connect your Stripe account. 
          </Text>
          <View style={styles.iconView}>
            <Text style={styles.numberInfo}>
              2
          ...
          <Text style={styles.contentInfo}>
            Next, you will be have to enter your credit or debit card details to be able to send gifts.
          </Text>
          <View style={styles.iconView}>
            <Text style={styles.numberInfo}>
              3
          ...
          <Text style={styles.contentInfo}>
            After finishing your account set up, add your contacts to start sending and receiving gifts.
          </Text>
          <TouchableOpacity
