...
interface IPaymentMethodScreenProps {
    navigation: NavigationProp<any>;
}

const PaymentMethodScreen: React.FC<IPaymentMethodScreenProps> = (props) => {
            ...
            <View style={styles.AboveWrapper}>
                <View style={styles.headerWrapper}>
                    ...
                    <Pressable style={styles.textLinkWrapper}>
                        <Icon3 name="plus" size={25} color="#FFF" onPress={goAddPaymentScreen} />
                    </Pressable>
                </View>
            </View>
            {fontsLoaded && (
